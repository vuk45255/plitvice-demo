Plitvice Club — a single-page site for the club in Inđija, Serbia. Design direction lives in [DESIGN.md](./DESIGN.md).
...
- **Events** — `lib/site.ts` contains three sample nights.
